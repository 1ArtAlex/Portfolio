...
//Регулировка высоты блоков food__column и dishes__item
function setEqualHeight() {
    var blocks = $(".food__item--block");
    var maxHeight = 0;

    blocks.height("auto"); // Сброс высоты перед пересчетом
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var bot = document.getElementById("wantBot");
    var bot1 = document.getElementById("wantBot1");
    var bot2 = document.getElementById("wantBot2");
...
//Плавное выплавание
$(document).ready(function () {
    var homeitems = $(".home__items");

    $(window).on("scroll", function () {
        var windowHeight = $(window).height();
        var scrollTop = $(window).scrollTop();
        var offset = homeitems.offset().top;

        if (scrollTop + windowHeight > offset) {
            homeitems.addClass("active");
        } else {
            homeitems.removeClass("active");
        }
    });
});
...
$(document).ready(function () {
    ...
    $(window).on("scroll", function () {
        var windowHeight = $(window).height();
        var scrollTop = $(window).scrollTop();
        var offset = homeimage.offset().top;

        if (scrollTop + windowHeight > offset) {
            homeimage.addClass("active");
        } else {
            homeimage.removeClass("active");
        }
    });
});

$(document).ready(function () {
    var servingimage = $(".serving__image");

    $(window).on("scroll", function () {
        var windowHeight = $(window).height();
        var scrollTop = $(window).scrollTop();
        var offset = servingimage.offset().top;

        if (scrollTop + windowHeight > offset) {
            servingimage.addClass("active");
        } else {
            servingimage.removeClass("active");
        }
    });
});

$(document).ready(function () {
    var servingitems = $(".serving__items");

    $(window).on("scroll", function () {
        var windowHeight = $(window).height();
        var scrollTop = $(window).scrollTop();
        var offset = servingitems.offset().top;

        if (scrollTop + windowHeight > offset) {
            servingitems.addClass("active");
        } else {
            servingitems.removeClass("active");
        }
    });
});
